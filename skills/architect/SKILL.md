---
name: architect
description: Make and record an architecture/design decision for non-trivial work — new subsystems, interfaces, data models, or significant refactors. Use when /plan flags a load-bearing decision. Delegates to the architect agent.
---
...
## Do this
1. **Delegate to the `architect` agent** with the problem, constraints, and the
...
## Exit criterion
A single recommended design with trade-offs stated. Then `/implement`.
